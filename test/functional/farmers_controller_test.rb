...
class FarmersControllerTest < ActionController::TestCase
  ...
  test "should update farmer" do
    put :update, id: @farmer, farmer: { email: @farmer.email, farm: @farmer.farm, name: @farmer.name, password_hash: @farmer.password_hash, produce: @farmer.produce, produce_price: @farmer.produce_price, wepay_access_token: @farmer.wepay_access_token, wepay_account_id: @farmer.wepay_account_id }
    assert_redirected_to farmer_path(assigns(:farmer))
  end
